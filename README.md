# Perfect-Example Mosquitto [简体中文](README.zh_CN.md)
...
This project demonstrates how to use Perfect-Mosquitto - A Swift MQTT Client.
...
You can clone, build and run by the following command.

```
$ git clone https://github.com/PerfectExamples/Perfect-Example-Mosquitto.git
$ cd Perfect-Example-Mosquitto
$ ./run.sh
```
